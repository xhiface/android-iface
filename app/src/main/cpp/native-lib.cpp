...
Java_xyz_zzyitj_iface_OpencvJni_init(JNIEnv *env, jobject instance, jstring path_) {
...
Java_xyz_zzyitj_iface_OpencvJni_postData(JNIEnv *env, jobject instance, jbyteArray data_,
